...
//this code is note optimize code time co=O(n^2) 
class Solution {
    
    public static Node find(Node curr1,Node curr2,Node findptr){
        if(findptr==null) return null;
        while(curr1!=findptr){
            curr1=curr1.next;
            curr2=curr2.next;
        }
    ...
    public Node cloneLinkedList(Node head) {
        ...
        //Assign random pinter to the  clone LL.
        tailCopy=headCopy;
        temp=head;
        while(temp!=null){
